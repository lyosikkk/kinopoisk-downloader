...
Браузерное расширение, которое добавляет кнопку «Скачать» прямо на страницы фильмов и сериалов Кинопоиска для удобного поиска и скачивания торрентов.

![Предпросмотр работы расширения](assets/preview.png)
...
- **Фильтры качества и озвучек**: Быстрая сортировка по разрешению (4K, 1080p, 720p) и популярным озвучкам (Дубляж, Кубик в кубе, LostFilm и др.).
...
![Интеграция кнопки в интерфейс](assets/button-preview.png)
...
![Включение режима разработчика](assets/install-step1.png)

3. Нажмите кнопку **Загрузить распакованное расширение** (Load unpacked) в левом верхнем углу.
4. Выберите папку, в которую вы распаковали скачанный архив.

![Загрузка распакованного расширения](assets/install-step2.png)
