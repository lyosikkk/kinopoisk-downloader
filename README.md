...
![Интерфейс для фильмов](screens/chrome_PlM7fLRSJO.png)

### Интерфейс для сериалов
![Интерфейс для сериалов](screens/chrome_07XxLiU2EZ.png)
...
![Страница управления расширениями браузера](screens/chrome_Tey26opjNA.png)
